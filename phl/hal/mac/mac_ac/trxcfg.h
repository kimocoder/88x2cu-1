...
#ifndef _MAC_TRXCFG_H_
#define _MAC_TRXCFG_H_
 ...
 * @retval u32
 */
u32 mac_enable_imr(struct mac_adapter *adapter, u8 band,
 ...
 * @retval u32
 */
u32 check_mac_en(struct mac_adapter *adapter, u8 band,
		 enum mac_ax_hwmod_sel sel);
/**
 * @}
 * @}
 ...
 * @retval u32
 */
u32 mac_check_access(struct mac_adapter *adapter, u32 offset);
/**
 * @}
 * @}
 */
 ...
 * @retval u32
 */
u32 mac_dbcc_enable(struct mac_adapter *adapter,
 ...
 * @retval u32
 */
u32 mac_tx_mode_sel(struct mac_adapter *adapter,
 ...
 * @retval u32
 */
u32 mac_two_nav_cfg(struct mac_adapter *adapter,
