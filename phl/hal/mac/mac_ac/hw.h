...
#ifndef _MAC_AC_HW_H_
#define _MAC_AC_HW_H_
...
/*--------------------Define MACRO--------------------------------------*/
#define ADDR_IS_AON_8852A(addr) ((addr) <= 0x3FF ? 1 : 0)
#define ADDR_IS_AON_8852B(addr) ((addr) <= 0x3FF ? 1 : 0)
#define ADDR_IS_AON_8852C(addr) ((addr) <= 0x3FF ? 1 : 0)
