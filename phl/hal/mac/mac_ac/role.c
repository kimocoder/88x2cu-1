...
static inline void __role_queue_head_init(struct mac_adapter *adapter,
...
static inline void __role_insert(struct mac_adapter *adapter,
...
static inline void __role_queue_before(struct mac_adapter *adapter,
				       struct mac_role_tbl_head *list,
				       struct mac_role_tbl *next,
				       struct mac_role_tbl *new_role)
{
...
static inline void __role_unlink(struct mac_adapter *adapter,
...
static struct mac_role_tbl *role_alloc(struct mac_adapter *adapter)
{
	struct mac_role_tbl *role;
...
static inline void role_queue_head_init(struct mac_adapter *adapter,
					struct mac_role_tbl_head *list)
{
...
static inline void role_enqueue(struct mac_adapter *adapter,
				struct mac_role_tbl_head *list,
				struct mac_role_tbl *new_role)
{
...
static inline struct mac_role_tbl *role_dequeue(struct mac_adapter *adapter,
						struct mac_role_tbl_head *list)
{
...
static struct mac_role_tbl *role_get(struct mac_adapter *adapter)
{
	struct mac_role_tbl *role;
...
static void role_return(struct mac_adapter *adapter,
			struct mac_role_tbl *role)
{
...
static u32 role_free(struct mac_adapter *adapter)
{
	struct mac_role_tbl *role;
...
u32 role_info_valid(struct mac_adapter *adapter,
...
u32 role_tbl_init(struct mac_adapter *adapter)
{
...
u32 role_tbl_exit(struct mac_adapter *adapter)
{
	u32 ret = MACSUCCESS;
...
u32 role_info_init(struct mac_adapter *adapter,
		   struct mac_ax_role_info *info)
{
	u8 i;
...
u32 sec_info_init(struct mac_adapter *adapter,
		  struct mac_ax_role_info *info)
{
	u8 i;
...
u32 sec_info_deinit(struct mac_adapter *adapter,
		    struct mac_ax_role_info *info,
		    struct mac_role_tbl *role)
{
	u32 i, ret;
...
u32 role_init(struct mac_adapter *adapter,
	      struct mac_role_tbl *role,
	      struct mac_ax_role_info *info)
{
...
u32 set_role_bss_clr(struct mac_adapter *adapter,
		     struct mac_ax_role_info *info)
{
...
u32 mac_add_role(struct mac_adapter *adapter, struct mac_ax_role_info *info)
{
	struct mac_role_tbl *role = NULL;
...
u32 mac_change_role(struct mac_adapter *adapter,
		    struct mac_ax_role_info *info)
{
	struct mac_role_tbl *role;
	u32 ret;
...
u32 mac_remove_role(struct mac_adapter *adapter, u8 macid)
{
	struct mac_role_tbl *role;
	u32 ret;
...
static u32 mac_remove_role_soft(struct mac_adapter *adapter, u8 macid)
{
...
u32 mac_remove_role_by_band(struct mac_adapter *adapter, u8 band, u8 sw)
{
	struct mac_role_tbl *role, *curr_role;
	struct mac_role_tbl_head *list_head = adapter->role_tbl;
	u32 ret = MACSUCCESS;
	u32 (*_rm_role)(struct mac_adapter *adapter, u8 macid);
...
struct mac_role_tbl *mac_role_srch(struct mac_adapter *adapter, u8 macid)
{
	struct mac_role_tbl *role;
	struct mac_role_tbl_head *list_head = adapter->role_tbl;
...
struct mac_role_tbl *mac_role_srch_by_addr_cam(struct mac_adapter *adapter,
					       u8 addr_cam_idx)
{
	struct mac_role_tbl *role;
	struct mac_role_tbl_head *list_head = adapter->role_tbl;
...
struct mac_role_tbl *mac_role_srch_by_bssid(struct mac_adapter *adapter,
					    u8 bssid_cam_idx)
{
	struct mac_role_tbl *role;
	struct mac_role_tbl_head *list_head = adapter->role_tbl;
...
u32 mac_get_macaddr(struct mac_adapter *adapter,
...
u32 mac_set_slot_time(struct mac_adapter *adapter, enum mac_ax_slot_time st)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 ret = MACSUCCESS;
...
static u32 mac_h2c_join_info(struct mac_adapter *adapter,
			     struct mac_ax_role_info *info)
{
	u8 *buf;
	#if MAC_AX_PHL_H2C
...
static u32 mac_fw_role_maintain(struct mac_adapter *adapter,
				struct mac_ax_role_info *info)
{
	u8 *buf;
	#if MAC_AX_PHL_H2C
