...
#define B_PL_AXIDMA_MASTER_BUSY BIT(1)
...
#define R_AX_RRSR1 0xC090
#define R_AX_RRSR1_C1 0xE090
...
#define B_AX_RSP_ACK_CHK_TX_NAV BIT(28)
...
#define B_AX_SRG_OBSS_PD_MIN_SH 24
#define B_AX_SRG_OBSS_PD_MIN_MSK 0xff
#define B_AX_SRG_OBSS_PD_MAX_SH 16
#define B_AX_SRG_OBSS_PD_MAX_MSK 0xff
#define B_AX_NONSRG_OBSS_PD_MIN_SH 8
#define B_AX_NONSRG_OBSS_PD_MIN_MSK 0xff
#define B_AX_NONSRG_OBSS_PD_MAX_SH 0
...
#define R_AX_RMAC_ERR_IMR 0xCEF6
#define R_AX_RMAC_ERR_IMR_C1 0xEEF6
#define B_AX_RMAC_CSI_TIMEOUT_INT_EN BIT(9)
#define B_AX_RMAC_DATA_ON_TIMEOUT_INT_EN BIT(8)
#define B_AX_RMAC_CCA_TIMEOUT_INT_EN BIT(7)
#define B_AX_RMAC_DMA_TIMEOUT_INT_EN BIT(6)
#define B_AX_RMAC_DATA_ON_TO_IDLE_TIMEOUT_INT_EN BIT(5)
#define B_AX_RMAC_CCA_TO_IDLE_TIMEOUT_INT_EN BIT(4)
