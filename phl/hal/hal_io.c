...
int dbg_rtw_write8(struct rtw_hal_com_t *hal, u32 addr, u8 val, const char *caller, const int line)
{
...
int dbg_rtw_write16(struct rtw_hal_com_t *hal, u32 addr, u16 val, const char *caller, const int line)
{
...
int dbg_rtw_write32(struct rtw_hal_com_t *hal, u32 addr, u32 val, const char *caller, const int line)
{
...
#ifdef CONFIG_SDIO_HCI
u8 dbg_rtw_sd_f0_read8(struct rtw_hal_com_t *hal, u32 addr, const char *caller, const int line)
{
...
#ifdef CONFIG_SDIO_INDIRECT_ACCESS
u8 dbg_rtw_sd_iread8(struct rtw_hal_com_t *hal, u32 addr, const char *caller, const int line)
{
...
u16 dbg_rtw_sd_iread16(struct rtw_hal_com_t *hal, u32 addr, const char *caller, const int line)
{
...
u32 dbg_rtw_sd_iread32(struct rtw_hal_com_t *hal, u32 addr, const char *caller, const int line)
{
...
int dbg_rtw_sd_iwrite8(struct rtw_hal_com_t *hal, u32 addr, u8 val, const char *caller, const int line)
{
	if (match_write_sniff(hal, addr, 1, val)) {
...
int dbg_rtw_sd_iwrite16(struct rtw_hal_com_t *hal, u32 addr, u16 val, const char *caller, const int line)
{
	if (match_write_sniff(hal, addr, 2, val)) {
...
int dbg_rtw_sd_iwrite32(struct rtw_hal_com_t *hal, u32 addr, u32 val, const char *caller, const int line)
{
	if (match_write_sniff(hal, addr, 4, val)) {
