...
void _print_txreq_mdata(struct rtw_t_meta_data *mdata, const char *func)
{
	if (DBG_PRINT_MDATA_ONCE == 1) {
		...
		RTW_PRINT("hw_aes_iv: %d\n", mdata->hw_aes_iv);
		RTW_PRINT("wd_page_size: %d\n", mdata->wd_page_size);
		RTW_PRINT("chk_en: %d\n", mdata->chk_en);
		RTW_PRINT("wp_int: %d\n", mdata->wp_int);
		RTW_PRINT("stf_mode: %d\n", mdata->stf_mode);
		RTW_PRINT("hdr_len: %d\n", mdata->hdr_len);
		RTW_PRINT("dma_ch: %d\n", mdata->dma_ch);
		...
		RTW_PRINT("force_txop: %d\n", mdata->force_txop);
		RTW_PRINT("ampdu_density: %d\n", mdata->ampdu_density);
		RTW_PRINT("lsig_txop_en: %d\n", mdata->lsig_txop_en);
		RTW_PRINT("txpwr_ofset_type: %d\n", mdata->txpwr_ofset_type);
		RTW_PRINT("no_ack: %d\n", mdata->no_ack);
		RTW_PRINT("obw_cts_dup_type: %d\n", mdata->obw_cts_dup_type);
		RTW_PRINT("signaling_ta_pkt_en: %d\n", mdata->signaling_ta_pkt_en);
		RTW_PRINT("ndpa: %d\n", mdata->ndpa);
		RTW_PRINT("snd_pkt_sel: %d\n", mdata->snd_pkt_sel);
		RTW_PRINT("sifs_tx: %d\n", mdata->sifs_tx);
		RTW_PRINT("ht_data_snd: %d\n", mdata->ht_data_snd);
		RTW_PRINT("rtt_en: %d\n", mdata->rtt_en);
		RTW_PRINT("spe_rpt: %d\n", mdata->spe_rpt);
		RTW_PRINT("bt_null: %d\n", mdata->bt_null);
		RTW_PRINT("wmm_tri_frame: %d\n", mdata->wmm_tri_frame);
		RTW_PRINT("null_1: %d\n", mdata->null_1);
		RTW_PRINT("null_0: %d\n", mdata->null_0);
		RTW_PRINT("raw: %d\n", mdata->raw);
		RTW_PRINT("group_bit_ie_ofst: %d\n", mdata->group_bit_ie_ofst);
		RTW_PRINT("bcn_tsf_ctrl: %d\n", mdata->bcn_tsf_ctrl);
		RTW_PRINT("signaling_ta_pkt_sc: %d\n", mdata->signaling_ta_pkt_sc);
		RTW_PRINT("force_bss_clr: %d\n", mdata->force_bss_clr);
		RTW_PRINT("sw_define: %d\n", mdata->sw_define);
		RTW_PRINT("rts_en: %d\n", mdata->rts_en);
		RTW_PRINT("cts2self: %d\n", mdata->cts2self);
		RTW_PRINT("rts_cca_mode: %d\n", mdata->rts_cca_mode);
		RTW_PRINT("hw_rts_en: %d\n", mdata->hw_rts_en);
		RTW_PRINT("ndpa_dur: %d\n", mdata->ndpa_dur);
